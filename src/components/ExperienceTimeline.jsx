...
import { BriefcaseIcon, GraduationCapIcon, CodeIcon, AwardIcon, ChevronRightIcon, GlobeIcon, CpuIcon, LayersIcon, UsersIcon, BookIcon, StarIcon, PuzzleIcon, LinkedinIcon, PlaneIcon, MusicIcon } from 'lucide-react';
...
const ExperienceTimeline = () => {
  ...
  const skills = {
    frontend: ["React.js (Redux, Context API, Hooks)", "React Native (IOS & Android)", "Next.js", "Vue.js", "TypeScript/JavaScript", "HTML5/CSS3", "Tailwind CSS", "Material-UI"],
    backend: ["Node.js/Express.js", "Node.js/Nest.js", "API RESTful", "Laravel", "MongoDB", "MySQL", "JWT", "OAuth", "Redis (Cache)"],
      ...
      <div className="container px-4 mx-auto relative z-10">
        ...
        >
          ...
          <p className="text-light/80 text-lg md:text-xl mb-8">
            7+ années d'expérience en développement web et mobile, avec une passion pour <span className="text-primary">React</span>, <span className="text-secondary">Node.js</span> et la création de <span className="text-accent">solutions innovantes</span>.
          </p>
        </div>
